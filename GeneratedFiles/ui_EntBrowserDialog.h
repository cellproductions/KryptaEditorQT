/********************************************************************************
** Form generated from reading UI file 'EntBrowserDialog.ui'
**
...
#ifndef UI_ENTBROWSERDIALOG_H
#define UI_ENTBROWSERDIALOG_H
...
public:
    ...
    void setupUi(QDialog *EntBrowserDialog)
    {
        if (EntBrowserDialog->objectName().isEmpty())
            EntBrowserDialog->setObjectName(QStringLiteral("EntBrowserDialog"));
        EntBrowserDialog->resize(640, 480);
        verticalLayout_2 = new QVBoxLayout(EntBrowserDialog);
        ...
        lbIcons = new QListWidget(EntBrowserDialog);
        ...
        lResName = new QLabel(EntBrowserDialog);
        ...
        lResImage = new QLabel(EntBrowserDialog);
        ...
        resProperties = new QTableWidget(EntBrowserDialog);
        ...
        bSelect = new QPushButton(EntBrowserDialog);
        ...
        bClose = new QPushButton(EntBrowserDialog);
        ...
        retranslateUi(EntBrowserDialog);

        QMetaObject::connectSlotsByName(EntBrowserDialog);
    } // setupUi
    ...
    void retranslateUi(QDialog *EntBrowserDialog)
    {
        ...
        ___qtablewidgetitem->setText(QApplication::translate("EntBrowserDialog", "Property", 0));
        QTableWidgetItem *___qtablewidgetitem1 = resProperties->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("EntBrowserDialog", "Value", 0));
        QTableWidgetItem *___qtablewidgetitem2 = resProperties->verticalHeaderItem(0);
        ___qtablewidgetitem2->setText(QApplication::translate("EntBrowserDialog", "Path", 0));
        QTableWidgetItem *___qtablewidgetitem3 = resProperties->verticalHeaderItem(1);
        ___qtablewidgetitem3->setText(QApplication::translate("EntBrowserDialog", "Type", 0));
        QTableWidgetItem *___qtablewidgetitem4 = resProperties->verticalHeaderItem(2);
        ___qtablewidgetitem4->setText(QApplication::translate("EntBrowserDialog", "Width", 0));
        QTableWidgetItem *___qtablewidgetitem5 = resProperties->verticalHeaderItem(3);
        ___qtablewidgetitem5->setText(QApplication::translate("EntBrowserDialog", "Height", 0));
        ...
        ___qtablewidgetitem6->setText(QApplication::translate("EntBrowserDialog", "Path:", 0));
        QTableWidgetItem *___qtablewidgetitem7 = resProperties->item(1, 0);
        ___qtablewidgetitem7->setText(QApplication::translate("EntBrowserDialog", "Type:", 0));
        QTableWidgetItem *___qtablewidgetitem8 = resProperties->item(2, 0);
        ___qtablewidgetitem8->setText(QApplication::translate("EntBrowserDialog", "Width:", 0));
        QTableWidgetItem *___qtablewidgetitem9 = resProperties->item(3, 0);
        ___qtablewidgetitem9->setText(QApplication::translate("EntBrowserDialog", "Height:", 0));
        resProperties->setSortingEnabled(__sortingEnabled);

        bSelect->setText(QApplication::translate("EntBrowserDialog", "Select and Close", 0));
        bClose->setText(QApplication::translate("EntBrowserDialog", "Close", 0));
    } // retranslateUi

};

namespace Ui {
    class EntBrowserDialog: public Ui_EntBrowserDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ENTBROWSERDIALOG_H
