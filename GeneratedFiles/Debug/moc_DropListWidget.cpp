...
#include "../../KryptaEditor/DropListWidget.h"
...
struct qt_meta_stringdata_DropListWidget_t {
    QByteArrayData data[1];
    char stringdata[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_DropListWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DropListWidget_t qt_meta_stringdata_DropListWidget = {
    {
...
const QMetaObject DropListWidget::staticMetaObject = {
    { &QListWidget::staticMetaObject, qt_meta_stringdata_DropListWidget.data,
      qt_meta_data_DropListWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DropListWidget.stringdata))
